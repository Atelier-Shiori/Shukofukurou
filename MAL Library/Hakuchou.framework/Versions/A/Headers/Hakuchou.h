...
//! Project version number for Hakuchou.
FOUNDATION_EXPORT double HakuchouVersionNumber;

//! Project version string for Hakuchou.
FOUNDATION_EXPORT const unsigned char HakuchouVersionString[];
