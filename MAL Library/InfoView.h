...
@property (strong) IBOutlet NSMenuItem *bookwalkerjapanmenuitem;
@property (strong) IBOutlet NSMenuItem *bookwalkerglobalmenuitem;
@property (strong) IBOutlet NSMenuItem *nativelymenuitem;
